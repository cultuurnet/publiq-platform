  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
          ...
          {errors.integrationType && <div className='error'>{errors.integrationType}</div>}
          ...
          <input type="text" name="firstNameOrganisation" id="firstNameOrganisation"
                 value={data.firstNameOrganisation}
                 onChange={e=> setData('firstNameOrganisation', e.target.value)}
                 placeholder="Voornaam" />
          {errors.firstNameOrganisation && <div className='error'>{errors.firstNameOrganisation}</div>}

          <input type="text" name="lastNameOrganisation" id="lastNameOrganisation"
                 value={data.lastNameOrganisation}
                 onChange={e=> setData('lastNameOrganisation', e.target.value)}
                 placeholder="Achternaam" />
          {errors.lastNameOrganisation && <div className='error'>{errors.lastNameOrganisation}</div>}

          <input type="email" name="emailOrganisation" id="emailOrganisation"
                 value={data.emailOrganisation}
                 onChange={e=> setData('emailOrganisation', e.target.value)}
                 placeholder="Emailadres" />
          {errors.emailOrganisation && <div className='error'>{errors.emailOrganisation}</div>}

          <h4>Contact technische partner</h4>
          <input type="text" name="firstNamePartner" id="firstNamePartner"
                 value={data.firstNamePartner}
                 onChange={e=> setData('firstNamePartner', e.target.value)}
                 placeholder="Voornaam" />
          {errors.firstNamePartner && <div className='error'>{errors.firstNamePartner}</div>}

          <input type="text" name="lastNamePartner" id="lastNamePartner"
                 value={data.lastNamePartner}
                 onChange={e=> setData('lastNamePartner', e.target.value)}
                 placeholder="Achternaam" />
          {errors.lastNamePartner && <div className='error'>{errors.lastNamePartner}</div>}

          <input type="email" name="emailPartner" id="emailPartner"
                 value={data.emailPartner}
                 onChange={e=> setData('emailPartner', e.target.value)}
                 placeholder="Emailadres" />
          {errors.emailPartner && <div className='error'>{errors.emailPartner}</div>}
          ...
          <br />
          <button type="submit" disabled={processing}>Integratie aanmaken</button>
      </form>
