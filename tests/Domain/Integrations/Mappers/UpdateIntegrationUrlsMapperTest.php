...
final class UpdateIntegrationUrlsMapperTest extends TestCase
{
     ...
     */
    private function getCurrentIntegrationUrlsForFullUpdate(): array
    {
        return [
            new IntegrationUrl(
    ...
    public function test_it_creates_an_updated_integration_from_request_and_current_urls(): void
    {
        ...
        $currentIntegrationUrls = $this->getCurrentIntegrationUrlsForFullUpdate();

        $actual = UpdateIntegrationUrlsMapper::map($request, $currentIntegrationUrls);
